...
def create_train_callbacks(model_number):
    filepath = "kerasSerialization/convnet" + str(
        model_number) + ".e{epoch:02d}-l{val_loss:.3f}.hdf5"
...
# Factor to split dataset into train and testset. Trainset = 95%, testset = 5%
split_factor = 0.95
batch_size = 128
...
# remote callback   -> Implements the connection to the hualos project
# (Keras visualization) Have a look on github
