...
Nach dem die Fussgängerstreifen detektiert wurden und das File crosswalks.json erstellt wurde, muss dies noch in ein passendes Format für MapRoulette gebracht werden. Dazu haben wir ein Python Script geschrieben, welches aus jedem gefundenen Fussgängerstreifen einen Task generiert.
