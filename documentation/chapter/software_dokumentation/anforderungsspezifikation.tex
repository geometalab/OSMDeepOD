...
\begin{center}
	...
	Database & Speicherort für die Positionen der ermittelten Fussgängersteifen und deren Strassenzugehörigkeit.\\ \hline
    \end{tabular}
\end{center}
...
Die Erkannten Fussgängerstreifen werden in einer Datenbank persistiert. Dabei sind die Positon (Koordinate lat/lon) wie auch die Strassenzugehörigkeit relevant.
