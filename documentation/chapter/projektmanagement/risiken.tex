...
\begin{table}[H]
    \begin{tabular}{|p{0.5cm}|p{2cm}|p{6cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{3cm}|p{4cm}|}
    \hline    
    \rowcolor{lightblue}
    Nr & Titel & Beschreibung & maximaler Schaden & Eintrittswahrscheinlichkeit & Gewichteter Schaden & Vorbeugung & Verhalten beim Eintreten \\ \hline
	...
	R4 & Download Orthofoto & Download der Orthofotos von Bing oder ähnlichen Quellen ist nicht möglich & 50h & 30\% & 15h & Alternativen im Augebehalten & Auf Bildmaterial der HSR zurückgreifen \\ \hline
