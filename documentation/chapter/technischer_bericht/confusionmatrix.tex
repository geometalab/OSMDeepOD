...
\begin{figure}[H]
	\centering
	\includegraphics[width=5cm]{images/Unsharp_Crosswalk2.png}\caption[Scale-invariant Feature Transform]{Undeutlicher Fussgängerstreifen ohne dominanten Fourierkoeffizienten}
\end{figure}
\newpage
